...
def main() -> int:
    ...
    base_dir = Path(args.output_root) / target_date

    markdown_path = Path(args.input) if args.input else base_dir / "daily-news.md"
    output_path = Path(args.output) if args.output else base_dir / "index.html"
